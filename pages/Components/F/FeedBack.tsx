...
const FeedBack = () => {
    return (
        <div className="contactForm bg-[#fff] px-[40px] py-[15px] rounded-xl">
            <h1 className='font-bold text-2xl text-center cursor-context-menu'>Write Your Feedback Here</h1>
            <form action="" className='grid items-center'>
                <textarea rows={6} cols={20} placeholder='Write Your Feedback Here' />
