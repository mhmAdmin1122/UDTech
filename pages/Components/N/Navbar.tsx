...
const Navbar = () => {
  ...
  return (
    <nav
      className={`desk-menu-box flex overflow-hidden relative flex-wrap items-center rounded-b-[36px] w-full h-auto px-[28px] py-[8px] text-2xl font-semibold top-0 z-50 justify-between ${
        isSticky
    ...
    >
      ...
      <div className="flex items-center gap-4">
        <b className="droper-icon-mob-menu">
