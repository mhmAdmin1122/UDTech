...
const Register = () => {
  ...
  async function register(ev: any) {
    ...
    if (!userType) {
      ...
      // Show error if userType is not selected
      // For simplicity, you can customize the error message as per your requirement
...
// const [password, setPassword] = useState("");
// const [confPassword, setConfPassword] = useState("");
// const [userType, setUserType] = useState(""); // Default userType is empty
// const [message, setMessage] = useState("");
// const [passwordError, setPasswordError] = useState<string[]>([]);
// const [confirmPasswordError, setConfirmPasswordError] = useState("");
// const [usernameError, setUsernameError] = useState("");
